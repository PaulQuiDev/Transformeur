...
def get_ds(config):
    ...
    for item in ds_raw:
        ...
        # Check if either source or target sentence exceeds 200 tokens
        if len(src_ids) <= 300 and len(tgt_ids) <= 300:
    ...
    #poubelle , val_ds_raw = random_split(filtered_ds_raw, [val_ds_size,train_ds_size])
